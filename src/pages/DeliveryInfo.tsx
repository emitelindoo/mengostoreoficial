    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto max-w-3xl px-4 pt-24 pb-16">
        ...
        <p className="text-muted-foreground mb-10">
          Enviamos para todo o Brasil via <strong className="text-foreground">SEDEX</strong>. Duas opções de frete: <strong className="text-foreground">Padrão (15 dias úteis) por R$ 29,90</strong> ou <strong className="text-foreground">Expresso (7 dias úteis) por R$ 42,80</strong>.
        </p>
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h2 className="font-semibold text-foreground mb-1">Opções de Frete</h2>
              <p className="text-muted-foreground text-sm">Padrão: 15 dias úteis por R$ 29,90. Expresso: 7 dias úteis por R$ 42,80. Ambos via SEDEX para todo o Brasil.</p>
            </div>
          </div>
        </div>
      </main>
